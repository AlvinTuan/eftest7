        ...
        <div className='section-two'>
            <div className='w-full relative lg:max-w-[1200px] md:max-w-[960px] md:mx-auto md:flex'>
                <img
                    ...
                    alt='topBadge'
                    className='z-[-1] top-0 w-full absolute'
                    loading='lazy'
                />
                <img
                ...
                <img
                    ...
                    className='z-[-1] left-0 w-full bottom-0 absolute'
                    loading='lazy'
                />
