                ...
                <div className='w-full relative bgColorGreen'>
                    ...
                    <div>
                        <img
                            ...
                            className='hidden md:flex md:absolute md:top-1/2 md:left-1/2 -translate-x-1/2 -translate-y-1/2'
                    ...
                    <div className='section-about'>
                        <div className='py-[72px] px-6 md:mx-auto md:py-[192px] md:px-0'>
                            <h1 className='text-3xl font-bold text-white mx-auto max-w-[250px] text-center pb-3 md:text-5xl md:max-w-[476px]'>
                ...
                <div className='section-about'>
                    <div className='w-full p-6 pt-12 pb-0 md:pr-[120px] lg:pl-[120px]'>
                        ...
                        <div className='max-w-[623px] pb-6'>
                            <p className='text-lg font-normal leading-7 mb-6'>
                                <span>
                ...
                <div className='section-about'>
                    <div className='w-full p-6 md:px-[120px]'>
                        ...
                        <div className='pt-9 md:flex'>
                            <CardAbout cardName='EF SET Academic Report'></CardAbout>
                        </div>
                        <hr className='ct-line' />
                    </div>
                </div>
