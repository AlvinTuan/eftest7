...
const Content = () => {
    return (
        <main className='w-full'>
            ...
            <div className='section-six w-full relative'>
                <div className='ct-section-body'>
                    <div className='w-full flex relative pt-[72px] flex-col pb-8 lg:px-[84px] xl:px-[120px]'>
                        <div className='lg:flex lg:pb-24'>
                            ...
                            <div className='m-auto flex items-center flex-col pb-6 lg:m-0 lg:self-center lg:text-start lg:mr-auto lg:flex-row lg:pb-0'>
                                ...
                                <p className='lg:text-base lg:max-w-[99px] self-center font-bold'>
                                    Years of experience
                                </p>
                            </div>
                        ...
                        <div className='w-full mx-auto flex flex-col lg:m-0 lg:mr-auto lg:flex-row'>
                            ...
                            <div className='flex'>
                                <Divider
                                    type='vertical'
                                    className='hidden lg:h-36 lg:my-0 lg:mx-[52px] lg:flex'
                                ></Divider>
                                <div className='my-12 mx-24 flex flex-col md:my-60 md:mx-10 lg:m-0'>
                                    <span className='m-0 text-5xl font-bold flex self-center lg:self-auto xl:text-[80px]'>
